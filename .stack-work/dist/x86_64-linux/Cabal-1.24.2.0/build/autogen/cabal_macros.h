...
/* package PHP-0.1.0.0 */
#define VERSION_PHP "0.1.0.0"
#define MIN_VERSION_PHP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "PHP-0.1.0.0-8vPSnFeoQ2c2BKntprWs4G"

#define CURRENT_PACKAGE_KEY "PHP-0.1.0.0-8vPSnFeoQ2c2BKntprWs4G"
